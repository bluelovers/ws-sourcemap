...
export type IRawSourceMap = IRawSourceMapJSON | RawSourceMap | IRawSourceMapJSONRuntime;
export type ILazySourceMapInput = IRawSourceMap | SourceMapGenerator | SourceMapConsumer | string;
